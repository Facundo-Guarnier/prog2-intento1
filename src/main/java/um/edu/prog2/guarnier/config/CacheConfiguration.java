...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, um.edu.prog2.guarnier.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, um.edu.prog2.guarnier.repository.UserRepository.USERS_BY_EMAIL_CACHE);
